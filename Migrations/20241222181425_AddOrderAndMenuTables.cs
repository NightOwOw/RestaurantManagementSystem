...
{
    /// <inheritdoc />
    public partial class AddOrderAndMenuTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Main Course", "Description of the item goes here", null, true, "Menu Item 1", 12.99m },
                    { 2, "Main Course", "Description of the item goes here", null, true, "Menu Item 2", 12.99m },
                    { 3, "Beverages", "Description of the item goes here", null, true, "Menu Item 3", 12.99m }
                });
